...
import { adjustStock, getStockItems, upsertStockItem } from '@/lib/database';
import type { StockItem, StockType } from '@/lib/types';
import { STOCK_TYPE_LABELS } from '@/lib/types';
      ...
      <Modal visible={modalVisible} animationType="slide" transparent>
        <View style={styles.modalOverlay}>
          <View style={[styles.modal, { backgroundColor: colors.card }]}>
            ...
            <PrimaryButton title="Kaydet" onPress={saveItem} />
            <PrimaryButton title="İptal" variant="secondary" onPress={() => setModalVisible(false)} />
          </View>
        </View>
      </Modal>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modal, { backgroundColor: colors.card }]}>
            ...
            <TextInput
              ...
              style={[styles.input, { borderColor: colors.border, color: colors.text }]}
            />
            <PrimaryButton title="Giriş (+)" onPress={() => doAdjust('in')} />
            <PrimaryButton title="Çıkış (-)" variant="danger" onPress={() => doAdjust('out')} />
            <PrimaryButton title="İptal" variant="secondary" onPress={() => setAdjustModal(false)} />
          </View>
        </View>
      </Modal>
    </View>
