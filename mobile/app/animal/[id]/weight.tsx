...
import { addWeightRecord, calculateADG, getAnimal, getWeightRecords } from '@/lib/database';
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={{ padding: 16 }}>
        <PrimaryButton title="+ Yeni Tartım Ekle" onPress={() => setModal(true)} />
      </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modal, { backgroundColor: colors.card }]}>
            ...
            <TextInput
              ...
              style={[styles.input, { borderColor: colors.border, color: colors.text }]}
            />
            <PrimaryButton title="Kaydet" onPress={save} />
            <PrimaryButton title="İptal" variant="secondary" onPress={() => setModal(false)} />
          </View>
        </View>
      </Modal>
    </View>
