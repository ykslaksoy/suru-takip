...
Geçici skala: **Ölçülsün → Zayıf → Fit → Sportmen → Kaslı → Süper Kuzu**  
Kod: `mobil/kaynak/kuzu-derece.ts` (`AGE_BANDS` + `gradeLamb`). Eşikler sonra ırk/ırk tipine göre netleştirilir.
